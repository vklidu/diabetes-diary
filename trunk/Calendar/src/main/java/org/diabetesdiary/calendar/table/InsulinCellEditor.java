 ...
 * @author Jiri Majer
 */
public class InsulinCellEditor extends DefaultCellEditor {

    JFormattedTextField formattedTF;
    NumberFormat doubleFormat;
    private Double minimum,  maximum;

    public InsulinCellEditor() {
        ...
        formattedTF.setFormatterFactory(new DefaultFormatterFactory(intFormatter));
    ...
    protected boolean userSaysRevert() {
        ...
        Object[] options = {NbBundle.getMessage(InsulinCellEditor.class, "Editace"), NbBundle.getMessage(InsulinCellEditor.class, "Zpet")};
        int answer = JOptionPane.showOptionDialog(
                SwingUtilities.getWindowAncestor(formattedTF),
                NbBundle.getMessage(InsulinCellEditor.class, "Hodnotu_insulinu_zadavejte_od_0-50."),
                NbBundle.getMessage(InsulinCellEditor.class, "Neplatna_hodnota_inzulinu"),
