...
public final class NewPatientVisualPanel1 extends JPanel {
    ...
    public NewPatientVisualPanel1(NewPatientWizardPanel1 wizard) {
        ...
        login.getDocument().addDocumentListener(new MyDocumentListener());
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, NbBundle.getMessage(NewPatientVisualPanel1.class,"name"));

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, NbBundle.getMessage(NewPatientVisualPanel1.class,"surname"));

        sex.setModel(createSexModel());

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, NbBundle.getMessage(NewPatientVisualPanel1.class,"login"));

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, NbBundle.getMessage(NewPatientVisualPanel1.class,"gender"));

        textDatum.setColumns(10);
        textDatum.setText(NbBundle.getMessage(NewPatientVisualPanel1.class, "NewRecord_DatePattern"));

        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, NbBundle.getMessage(NewPatientVisualPanel1.class,"dateofbirth"));

        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, NbBundle.getMessage(NewPatientVisualPanel1.class,"email"));

        injection.setSelected(true);
        org.openide.awt.Mnemonics.setLocalizedText(injection, NbBundle.getMessage(NewPatientVisualPanel1.class,"inspen"));
        injection.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        injection.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(pump, NbBundle.getMessage(NewPatientVisualPanel1.class,"inspump"));
